...
Briar is available for devices running Android.
...
Briar hasn't been released to the public yet, so it's not available from the Play Store. To install Briar, follow these steps:
